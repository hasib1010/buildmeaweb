    ...
    <div className="  min-h-screen">
      <div className="container mx-auto px-4 py-8 sm:py-12">
        <div className="max-w-5xl mx-auto">
          ...
          {!planDetails.id ? (
            <div className="text-center p-6 sm:p-8 rounded-lg shadow-sm">
            ...
            <div className=" border-2 border-green-200 p-6 sm:p-8 rounded-lg text-center shadow-sm">
              ...
              <div className=" p-4 sm:p-6 rounded-lg shadow-sm max-w-md mx-auto mb-6 sm:mb-8">
            ...
            <div className="flex flex-col lg:flex-row gap-6 sm:gap-8">
              ...
              <div className="w-full lg:w-1/3 order-2 lg:order-1">
                <div className=" border border-gray-200 rounded-lg p-4 sm:p-6 shadow-sm lg:sticky lg:top-8">
