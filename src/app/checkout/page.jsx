...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Prepare payment details (in a real app, you would use a secure payment processor)
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Complete your order and we'll start building your website</p>
        </div>
        
        {!planDetails.id ? (
          <div className="text-center p-8">
            <p className="mb-4">Loading plan details...</p>
          </div>
        ) : orderCompleted ? (
            ...
            <div className="md:col-span-1">
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 sticky top-8">
                ...
                <div className="mt-6 text-sm">
                  <p className="mb-2">
                    <span className="text-green-600">✓</span> Fast Turnaround (5-7 days)
                  </p>
                  <p className="mb-2">
                    <span className="text-green-600">✓</span> No Hidden Fees
                  </p>
                  <p className="mb-2">
                    <span className="text-green-600">✓</span> 100% Satisfaction Guarantee
                  </p>
                  <p>
                ...
                <div className="mt-6">
                  <Link href="/plans" className="text-blue-600 text-sm hover:underline">
                    ← Change Plan
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                      <label htmlFor="websiteType" className="block mb-1 font-medium">
                        Website Type
                      </label>
                      <select
                        id="websiteType"
                  ...
                  <div className="space-y-4 mb-6">
                    <div>
                      <label htmlFor="websiteGoals" className="block mb-1 font-medium">
                    ...
                    <div>
                      <label htmlFor="existingWebsite" className="block mb-1 font-medium">
                    ...
                    <div>
                      <label htmlFor="customRequirements" className="block mb-1 font-medium">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              id="cardCvv"
                              name="cardCvv"
                              className={`w-full p-3 border rounded-lg ${errors.cardCvv ? 'border-red-500' : 'border-gray-300'}`}
                              placeholder="123"
